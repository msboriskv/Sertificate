...
pdf.cell(0, 340, 'Получил ' + full_name, new_x="LMARGIN", align='C')

pdf.set_font("Sans", "", 16)
pdf.cell(0, 380, 'за участие в XII международном форуме', new_x="LMARGIN", align='C')
pdf.cell(0, 395, '"ОБРАЗОВАНИЕ: РЕАЛИИ И ПЕРСПЕКТИВЫ"', new_x="LMARGIN", align='C')
